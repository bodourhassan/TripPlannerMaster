...
//        note1.setNoteBody("any note1");
//        note1.setStatus("not determined");
//        trip6.getTripNotes().add(note1);
//        Note note2 = new Note();
//        note2.setNoteBody("any note2");
//        note2.setStatus("not determined");
//        trip6.getTripNotes().add(note2);
//        boolean flag6 = new TripTableOperations(getApplicationContext()).insertTrip(trip6);
//        Toast.makeText(getApplicationContext(), flag6+"", Toast.LENGTH_LONG).show();
////
...
//        }
        Trip trip = new TripTableOperations(getApplicationContext()).selectSingleTrips(8+"");
        trip.setTripName("09");
        trip.setTripTime("wed");
...
//        new TripTableOperations(getApplicationContext()).deleteTrip(1+"");
    }
